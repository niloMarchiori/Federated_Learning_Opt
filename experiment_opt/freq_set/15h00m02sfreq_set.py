...
experiment_config = {
    "ipBase": "10.0.0.0/24",
    "experiments_folder": "experiment_opt",
    "date_prefix": False
}
...
def topology():
    ...
    server_script_volume = ['/home/nilo/Documents/AprendizadoFederado/MininetFed-Opt/util/serveropt:/script']
